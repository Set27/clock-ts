"use strict";
const clockLineSecond = document.querySelector('.clock-line-seconds');
const clockLineMinute = document.querySelector('.clock-line-minutes');
const clockLineHour = document.querySelector('.clock-line-hours');
function setDate() {
    const now = new Date();
